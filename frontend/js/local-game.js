...
const BACKEND_URL = (typeof location !== 'undefined' && (location.hostname === 'localhost' || location.hostname === '127.0.0.1' || location.hostname === ''))
...
const sons = {
  ...
  applaudissements: new Audio("assets/audio/Applaudissements.mp3"),
  hue: new Audio("assets/audio/hue.mp3"),
};
...
function afficherEcranReponse() {
  ...
  if (optionsConteneur) {
    ...
    optionsMelangees.forEach((option) => {
      ...
      boutonOption.dataset.sound = "selectionReponse";
